    ...
    def __init__(self):
        ...
        self.IMAGES = [
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\WhiteKing.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\WhiteQueen.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\WhiteRook.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\WhiteBishop.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\WhiteKnight.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\WhitePawn.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\BlackKing.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\BlackQueen.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\BlackRook.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\BlackBishop.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\BlackKnight.png"), (64, 85)
            ),
            pygame.transform.scale(
                pygame.image.load("Exercise\Game\Chess\Assets\BlackPawn.png"), (64, 85)
            ),
        ]
        self.colors = [[], [], [], [], [], [], [], []]
        self.createBoard()
